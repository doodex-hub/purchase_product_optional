# Smoke Test — purchase_product_optional (18.0 → 19.0)
...
|---|---|---|---|---|
| 2026-08-26 | Docker `odoo:19.0`, langkah 2-9 | Tour otomatis (AI, headless Chrome) | Pass | 15/15 langkah, lihat `docker-env/logs/odoo_test3.log` |
